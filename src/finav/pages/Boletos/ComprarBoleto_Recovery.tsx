          ...
          <Card className="relative overflow-visible rounded-2xl shadow-xl">
            ...
            <CardFooter className="flex justify-center">
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 flex gap-4">
                ...
                <Button
                  className="px-6 py-3 rounded-full! text-sm! border-purple-600! bg-purple-600 text-white!"
                  onClick={() => cantidad < 4 && setCantidad(cantidad + 1)}
                  disabled={reservaActiva!}
                >
                  +1
                </Button>
          ...
          <Card className="rounded-2xl shadow-xl p-6 space-y-6">
            ...
            {reservaActiva && (
              <div className="flex justify-center">
                <Button
                  type="button"
                  className="bg-gray-500 hover:bg-gray-600 text-white rounded-full! px-4 py-2 text-sm"
            ...
            {reservaActiva && (
              <form onSubmit={handleSubmit(pagar)} className="space-y-4">
                <input
                  type="email"
                ...
                <Button
                  className="w-1/3 bg-pink-600 hover:bg-pink-700 text-white rounded-full! py-3 text-lg"
                  disabled={loading}
                  type="submit"
                >
