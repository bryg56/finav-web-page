export const Informacion = () => {
  return (
    <div className="flex justify-center items-center w-full px-4 md:px-20 lg:px-60">
      {/* Titulo o imagen  */}
      <div className="w-full">
        ...
        <div className="mt-3 mb-3 flex justify-center text-center text-shadow-md px-2 md:px-10 ">
          AnimAGSión está conformado por un grupo de artistas mexicanos
